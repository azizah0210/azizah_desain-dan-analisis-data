...
int main()
{
    ...
    cout << "Kami menggunakan metode open addressing" << endl;
    cout << "ada 3 cara, pilih salah satu dengan memilih a,b, atau" << endl;
    cout << "c :" << endl;
    ...
    cout << endl << endl << "Proses pemasukan data ke" << endl;
    cout << "hashtable " << endl;
...
*/
    cetak(n);
    cout << "Diatas adalah hasil output Hashtable" << endl;
    cout << "dengan cara \"" << cara << "\"" << endl;
    switch(pilihan)
    {
        case 'a':
